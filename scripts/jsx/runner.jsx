// Include JSON shim (needed in ExtendScript)
...
// Polyfill for Object.keys (ExtendScript-safe)
...
(function () {
  ...
  try {
    ...
    var pkg = JSON.parse(raw); // safe now, thanks to json2.jsx

    if (!pkg.rows || !(pkg.rows instanceof Array)) {
      throw new Error("Invalid package.json: missing 'rows' array");
    }
    ...
    if (pkg.rows.length > 0) {
      ...
      var keys = Object.keys(r0.data || {});
      $.writeln("Runner: data keys = " + keys.join(", "));
